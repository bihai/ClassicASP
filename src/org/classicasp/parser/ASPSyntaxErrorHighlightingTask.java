 ...
 * @author mobrien
 */
public class ASPSyntaxErrorHighlightingTask extends ParserResultTask
{
    ...
    public void run(Result result, SchedulerEvent event) 
    {
        try
        {
            ASPParserResult aspResult = (ASPParserResult) result;
            List<ParseException> syntaxErrors = aspResult.getJavaParser().syntaxErrors;
            ...
            HintsController.setErrors(document, "classicasp", errors);
        }
